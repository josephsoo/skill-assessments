...
We can check for normality using histograms of energy use for each continent
...
```
As seen from bar chart, Macao SAR, China and Monaco are tied for having the highest `'Population density (people per sq. km of land area)'` across all years.
