...
```{r}
# Calculating the mean population density by country, then extracting the 5 countries with the greatest population density.
...
```
As seen from bar chart, Macao SAR, China has the greatest population density across the years.
